...
srcdir = .
topdir = /usr/share/rvm/rubies/ruby-2.2.1/include/ruby-2.2.0
hdrdir = $(topdir)
arch_hdrdir = /usr/share/rvm/rubies/ruby-2.2.1/include/ruby-2.2.0/x86_64-linux
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/usr/share/rvm/rubies/ruby-2.2.1
...
ORIG_SRCS = example_wrap.cxx
SRCS = $(ORIG_SRCS) 
OBJS = example_wrap.o
HDRS = $(srcdir)/map_util.h
TARGET = example
TARGET_NAME = example
